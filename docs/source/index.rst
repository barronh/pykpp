...
The key value of `pyrkpp` is to make simple simulations easy to run in common
cloud environments like Google Colab, AWS SageMaker, Binder, or even
Jupyter-lite.
...
https://github.com/barronh/pykpp/issues
